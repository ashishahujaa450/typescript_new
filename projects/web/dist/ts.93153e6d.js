...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/ts/View/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  CollectionView.prototype.render = function () {
    ...
    for (var _i = 0, _a = this.collection.model; _i < _a.length; _i++) {
      var model = _a[_i];
...
function () {
  ...
  View.prototype.render = function () {
    this.parent.innerHTML = ''; //creating tempalte

    var templateElement = document.createElement('template');
    templateElement.innerHTML = this.template(); // binding event to the html components

    this.bindEvent(templateElement.content); //region 

    this.mapRegions(templateElement.content); //render all views nesting

    this.onRender(); //appending html to the dom using the parent
...
exports.View = View;
},{}],"src/ts/View/UserShow.ts":[function(require,module,exports) {
"use strict";
...
},{"./View":"src/ts/View/View.ts"}],"src/ts/View/userList.ts":[function(require,module,exports) {
"use strict";
...
},{"./CollectionView":"src/ts/View/CollectionView.ts","./UserShow":"src/ts/View/UserShow.ts"}],"src/ts/Models/Eventing.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Eventing() {
    ...
    this.events = {}; //registering event in events object
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/ts/Models/Collection.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Collection(rooUrl, deserialize) {
    this.rooUrl = rooUrl;
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rooUrl).then(function (response) {
...
},{"./Eventing":"src/ts/Models/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/ts/Models/Model.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Model(attribute, event, sync) {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attribute.getAll()).then(function (response) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
exports.Model = Model;
},{}],"src/ts/Models/Attribute.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/ts/Models/Sync.ts":[function(require,module,exports) {
"use strict";
...
exports.Sync = Sync;
},{"axios":"node_modules/axios/index.js"}],"src/ts/Models/User.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attribute_1.Attributes(attrs), new Eventing_1.Eventing(), new Sync_1.Sync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/ts/Models/Model.ts","./Attribute":"src/ts/Models/Attribute.ts","./Eventing":"src/ts/Models/Eventing.ts","./Sync":"src/ts/Models/Sync.ts","./Collection":"src/ts/Models/Collection.ts"}],"src/ts/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
console.log(users);
},{"./View/userList":"src/ts/View/userList.ts","./Models/Collection":"src/ts/Models/Collection.ts","./Models/User":"src/ts/Models/User.ts"}],"C:/Users/De-coder/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/De-coder/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/ts/index.ts"], null)
