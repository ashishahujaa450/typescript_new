...
function () {
  function View(parent, model) {
    ...
    this.mapRegions = function (fragment) {
      ...
      for (var key in regionsMap) {
        ...
        _this.regions[key] = fragment.querySelector(selector);
      }
    };
  ...
  View.prototype.eventsBind = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      ...
      fragment.querySelectorAll(selector).forEach(function (elment) {
...
},{"./CollectionView":"src/View/CollectionView.ts","./UserShow":"src/View/UserShow.ts"}],"src/Model/Eventing.ts":[function(require,module,exports) {
"use strict";
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/Model/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"./Eventing":"src/Model/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/Model/Model.ts":[function(require,module,exports) {
"use strict";
...
exports.Model = Model;
},{}],"src/Model/Attribute.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/Model/Sync.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attribute_1.Attribute(attrs), new Sync_1.Sync(rootUrl), new Eventing_1.Eventing());
  };
...
exports.User = User;
},{"./Model":"src/Model/Model.ts","./Eventing":"src/Model/Eventing.ts","./Attribute":"src/Model/Attribute.ts","./Sync":"src/Model/Sync.ts","./Collection":"src/Model/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
user.fetch();
},{"./View/UserList":"src/View/UserList.ts","./Model/Collection":"src/Model/Collection.ts","./Model/User":"src/Model/User.ts"}],"C:/Users/De-coder/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/De-coder/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
